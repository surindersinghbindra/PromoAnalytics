...
public class LocationSearchActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    private static LatLngBounds BOUNDS_GREATER_SYDNEY = new LatLngBounds(
    ...
    private ResultCallback<PlaceBuffer> mUpdatePlaceDetailsCallback
        ...
        public void onResult(PlaceBuffer places) {
            ...
            intent.putExtra(AppConstants.LATITUDE, place.getLatLng());
            intent.putExtra(AppConstants.LOCATION_NAME, place.getName());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(this)
                .enableAutoManage(this, 4 /* clientId */, this)
                .addApi(Places.GEO_DATA_API)
                .build();

        if (getIntent() != null) {

            LatLng latLng = getIntent().getParcelableExtra(AppConstants.LATITUDE);
            BOUNDS_GREATER_SYDNEY = new LatLngBounds(new LatLng(latLng.latitude, latLng.longitude), new LatLng(latLng.latitude, latLng.longitude));
        }

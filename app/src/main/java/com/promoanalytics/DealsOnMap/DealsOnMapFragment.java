package com.promoanalytics.DealsOnMap;
 ...
 */
public class DealsOnMapFragment extends RootFragment implements OnMapReadyCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_deals_on_map, container, false);

        mMapView = (MapView) view.findViewById(R.id.mvDeals);
        mMapView.onCreate(savedInstanceState);
        mMapView.getMapAsync(DealsOnMapFragment.this);
        return view;
    }

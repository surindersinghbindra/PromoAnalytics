...
public class Userfav {
    ...
    public Userfav(final Context context, final String dealid, final String satsvalue, final ImageView filled, final ImageView unfld)
    {
...
if(satsvalue=="1"){
    ...
    unfld.setVisibility(View.GONE);
}else{
    filled.setVisibility(View.GONE);
    unfld.setVisibility(View.VISIBLE);
}

 ...
 */
public class LoginAPiCpn {

    StringRequest sr;
    MyApplication global;


    public LoginAPiCpn(final Activity context, final String mobile, final String password) {
        ...
        sr = new StringRequest(Request.Method.POST, BaseUrlCPn.BASE_URL + BaseUrlCPn.login, new Response.Listener<String>() {
            @Override
